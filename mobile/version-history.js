const VERSIONS = [
  {
    ...
    date: "06.09.2026",
    changes: [
      "Раздел «Продажи» переработан в общий журнал «Операции»: продажи, отмены и движение денег теперь собраны в одном месте; фиксируется автор отмены.",
      ...
      "Убрана повторная заставка при возврате в уже запущенное приложение; в Настройки добавлена история версий."
    ]
  },
  {
    version: "0.6.8",
